...
width:80px;
  ...
  <table align="center" width="550">
        ...
        <tr> 服务类型 <td> </td>
          <td> <s:select  label="服务类型"  list='#{"投诉服务":"投诉服务","售前服务":"售前服务","售后服务":"售后服务","咨询服务":"咨询服务"}' name="serviceInfo.serviceType"></s:select></td></tr>
        <br><br>
        <tr><td> 操作状态</td>
           <td> <s:select  label="操作状态"  list='#{"新创建":"新创建","未创建":"未创建" }' name="serviceInfo.serviceStatus"></s:select></td></tr>
        <br><br>
        ...
        <tr>
            ...
            <s:hidden name="serviceInfo.id"></s:hidden>
             ...
             <s:submit label="添加" value="添加"></s:submit>
               </td><td>
